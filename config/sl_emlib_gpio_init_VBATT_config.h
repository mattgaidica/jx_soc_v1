#ifndef SL_EMLIB_GPIO_INIT_VBATT_CONFIG_H
#define SL_EMLIB_GPIO_INIT_VBATT_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_VBATT_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_VBATT_MODE        gpioModeInput

// <o SL_EMLIB_GPIO_INIT_VBATT_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_VBATT_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_VBATT
// $[GPIO_SL_EMLIB_GPIO_INIT_VBATT]
#define SL_EMLIB_GPIO_INIT_VBATT_PORT            gpioPortC
#define SL_EMLIB_GPIO_INIT_VBATT_PIN             4
// [GPIO_SL_EMLIB_GPIO_INIT_VBATT]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_VBATT_CONFIG_H
