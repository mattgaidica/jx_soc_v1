#ifndef SL_EMLIB_GPIO_INIT_DRDY_CONFIG_H
#define SL_EMLIB_GPIO_INIT_DRDY_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_DRDY_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_DRDY_MODE        gpioModeInputPull

// <o SL_EMLIB_GPIO_INIT_DRDY_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_DRDY_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_DRDY
// $[GPIO_SL_EMLIB_GPIO_INIT_DRDY]
#define SL_EMLIB_GPIO_INIT_DRDY_PORT             gpioPortA
#define SL_EMLIB_GPIO_INIT_DRDY_PIN              5
// [GPIO_SL_EMLIB_GPIO_INIT_DRDY]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_DRDY_CONFIG_H
